...
export default function CampaignsClient() {
    ...
    return (
        <DashboardLayout>
            {/* Navigation */}
            <Disclosure as="nav" className="bg-white text-black dark:bg-gray-900 dark:text-white w-full shadow mt-5 pt-5">
                <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 pt-5 mt-5">
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        {/* Logo + Tabs */}
                        <div className="flex flex-1 items-center justify-center sm:items-stretch w-full sm:justify-start pl-[200px]">
