      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Campaign Notifications</h1>
              <p className="text-gray-600">Monitor your email verification campaigns in real-time</p>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{getTypeCount('success')}</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600">{getTypeCount('warning')}</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">{getTypeCount('error')}</p>
              </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{getTypeCount('info')}</p>
              </div>
              ...
              <div className="flex space-x-2">
                {['all', 'success', 'warning', 'error', 'info'].map((type) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${filter === type
        ...
        <div className="space-y-4">
          {filteredNotifications.map((notification) => (
            <div
              key={notification.id}
              className={`bg-white rounded-xl p-6 shadow-sm border transition-all duration-200 hover:shadow-md ${getBgColor(notification.type)}`}
            >
                ...
                <div className="mt-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${(notification.stats.verified / notification.stats.total) * 100}%`
                      }}
                    ></div>
                  </div>
                </div>
