    ...
    switch (currentStep) {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-medium text-blue-900">Campaign Tips</h4>
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Email Source</label>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div 
                  ...
                  onClick={() => handleInputChange('emailSource', 'upload')}
                >
                  <Upload className="w-8 h-8 text-gray-600 mx-auto mb-3" />
                  <h3 className="text-lg font-medium text-gray-900 text-center mb-2">Upload File</h3>
                  <p className="text-sm text-gray-600 text-center">CSV, Excel, or TXT file with email addresses</p>
                </div>
                ...
                <div 
                  ...
                  onClick={() => handleInputChange('emailSource', 'manual')}
                >
                  <FileText className="w-8 h-8 text-gray-600 mx-auto mb-3" />
                  <h3 className="text-lg font-medium text-gray-900 text-center mb-2">Manual Entry</h3>
                  <p className="text-sm text-gray-600 text-center">Type or paste email addresses manually</p>
                </div>
              </div>
            </div>
                ...
                <div className="text-center">
                  {campaignData.uploadedFile ? (
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <div>
                        <p className="text-lg font-medium text-gray-900">{campaignData.uploadedFile.name}</p>
                        <p className="text-sm text-gray-600">{(campaignData.uploadedFile.size / 1024).toFixed(1)} KB</p>
                      </div>
                      <button 
      ...
      case 3:
        return (
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Verification Level</label>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  >
                    <level.icon className="w-6 h-6 text-blue-600 mb-3" />
              ...
              <div className="space-y-3">
                <label className="flex items-center">
                  <input
                    ...
                    name="targetAudience"
                    value="all"
                    checked={campaignData.targetAudience === 'all'}
                    onChange={(e) => handleInputChange('targetAudience', e.target.value)}
                    className="mr-3"
                  />
                  <span>Verify all email addresses</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    name="targetAudience"
                    value="new"
                    checked={campaignData.targetAudience === 'new'}
                    onChange={(e) => handleInputChange('targetAudience', e.target.value)}
                    className="mr-3"
                  />
                  <span>Only new/unverified addresses</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    name="targetAudience"
                    value="failed"
                    checked={campaignData.targetAudience === 'failed'}
                    onChange={(e) => handleInputChange('targetAudience', e.target.value)}
                    className="mr-3"
                  />
                  <span>Previously failed verifications</span>
                </label>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <label className="flex items-center">
                <input
                  ...
                  className="mr-3"
                />
                <span className="text-sm text-gray-700">Send email notifications when campaign completes</span>
              </label>
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="mr-3"
                />
                <span className="text-sm text-gray-700">Automatically retry failed verifications after 24 hours</span>
              </label>
            </div>
          </div>
        );
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Campaign Schedule</label>
              <div className="space-y-4">
                <label className="flex items-center">
                  <input
                    type="radio"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Begin verification as soon as campaign is created</p>
                  </div>
                </label>
                ...
                <label className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-3">Set a specific date and time to start verification</p>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-medium text-yellow-900">Scheduling Notice</h4>
          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Email Source:</span>
                  <span className="font-medium capitalize">{campaignData.emailSource}</span>
                </div>
                
                {campaignData.uploadedFile && (
                  <div className="flex justify-between">
                    <span className="text-gray-600">Uploaded File:</span>
                    <span className="font-medium">{campaignData.uploadedFile.name}</span>
                  </div>
                )}
                
                <div className="flex justify-between">
                  <span className="text-gray-600">Verification Level:</span>
                  <span className="font-medium capitalize">{campaignData.verificationLevel}</span>
                </div>
                
                <div className="flex justify-between">
                  <span className="text-gray-600">Schedule:</span>
                  <span className="font-medium">
                    {campaignData.scheduleType === 'immediate' ? 'Start Immediately' : 
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{campaignData.notifications ? 'Enabled' : 'Disabled'}</span>
                </div>
              </div>
            </div>
        ...
        <div className="px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Create a new email verification campaign</p>
            </div>
          </div>
        </div>
      </div>
